...
### [3] [Perturbations and quasinormal modes of black holes in general relativity coupled to nonlinear electrodynamics](https://arxiv.org/abs/2609.14309)
...
### [4] [Localization of Vector and Fermion Fields on a Thick Brane with a Lump-type Scalar Background](https://arxiv.org/abs/2609.14324)
...
### [5] [Self-Gravitation of Mode Quanta in a Causal Resonator: One-Loop Finiteness in Linearized Quantum Gravity and the Emergence of the Dark-Energy Scale](https://arxiv.org/abs/2609.14650)
*Christian Rembe*
...
### [6] [Full set of scenarios of high energy collision in the Schwarzschild background and kinematic censorship](https://arxiv.org/abs/2609.14701)
...
### [7] [Quasinormal modes of Reissner-Nordström black hole from bound state spectrum](https://arxiv.org/abs/2609.14979)
...
### [9] [Dynamical Structure of Einasto Dark Matter Wormholes: Thin-Shell Stability and Particle Transitions](https://arxiv.org/abs/2609.15140)
...
### [10] [Thermodynamic stability of the new black hole solution in $f(R,G,T)$ gravity](https://arxiv.org/abs/2609.15156)
...
### [11] [Testing the equivalence principle with lunar laser ranging residuals from different planetary and lunar ephemerides](https://arxiv.org/abs/2609.15303)
...
### [12] [Deterministic denoising of long-duration gravitational-wave signal candidates with $α$-(de)blending](https://arxiv.org/abs/2609.15308)
...
### [13] [Cosmological dynamics and structure formation in Tsallis-Cirto entropy-inspired modified gravity](https://arxiv.org/abs/2609.15325)
...
### [14] [Perturbations of a Schwarzschild black hole and Newman-Unti gauge](https://arxiv.org/abs/2609.15730)
...
### [15] [Analysis of GWTC-3 with multiple quasicircular models](https://arxiv.org/abs/2609.15827)
...
### [16] [Curvture Regularization and Dynamical Vacuum Structure in Pseudo-Complex General Relativity](https://arxiv.org/abs/2609.15916)
...
### [17] [Distinguishing cosmology, astrophysics and systematics: the Bayesian search for a primordial gravitational-wave background in next-generation observatories](https://arxiv.org/abs/2609.15931)
...
### [18] [Approximating neutron-star radii using gravitational-wave only measurements with symbolic regression](https://arxiv.org/abs/2504.19962)
*Michał Bejger*
...
### [19] [BudgetBench: A Budget-Tiered Protocol and Pilot Harness for Memory Strategy Evaluation in Local Large Language Model Agents](https://arxiv.org/abs/2609.13149)
...
### [20] [A derivative-fidelity failure mode in physics-informed neural networks: strengthened benchmark evidence from function-value training](https://arxiv.org/abs/2609.13171)
*Koji Koyamada*
...
### [21] [Land Art as a Big-Data Climate Sensor](https://arxiv.org/abs/2609.13182)
...
### [22] [LLMs or Naive Bayes? Old Gems or New Ways](https://arxiv.org/abs/2609.13185)
...
### [23] [Early Prediction of Satellite Collision Probability Using a Hybrid TCN-Transformer Model for a CDM-Based Conjunction Analysis Framework](https://arxiv.org/abs/2609.13191)
...
### [24] [Evaluating LLM-Generated Rules for Heart Disease Prediction](https://arxiv.org/abs/2609.13192)
...
### [25] [Machine Unlearning for Speech Question Answering in Large Audio-Language Models](https://arxiv.org/abs/2609.13195)
*Zhe Liu*
...
### [26] [SPICE: Simple Polysemantic Feature Interpretation via Clustering-based Explanation](https://arxiv.org/abs/2609.13198)
...
### [27] [Discovering and Preserving Category Correlation Knowledge via Adaptive Reciprocal Knowledge Distillation](https://arxiv.org/abs/2609.13199)
...
### [28] [Scalable partial information decomposition for symptom networks via supervised embeddings](https://arxiv.org/abs/2609.13203)
...
### [29] [ReCAST: Reward Credit Assignment across Timesteps for Online Diffusion Reinforcement](https://arxiv.org/abs/2609.13425)
...
### [30] [Certifiably Interpretable Training of ReLU-MLPs for Boolean Tasks with Guaranteed Truth-Table Generalization](https://arxiv.org/abs/2609.13439)
...
### [31] [Efficient Online Inverse Optimization with $O(d)$ Regret](https://arxiv.org/abs/2609.13440)
...
### [32] [Learning to Solve Hard Problems in RL for LLMs by Never Giving Up](https://arxiv.org/abs/2609.13443)
...
### [33] [On the Potential of Multi-Task Learning in Predictive Process Monitoring](https://arxiv.org/abs/2609.13477)
...
### [34] [One Spectrum, Two Resources: Data-Memory Scaling in Autoregressive Prediction](https://arxiv.org/abs/2609.13500)
...
### [35] [Pretraining for Sample-Efficient Neural Interfaces](https://arxiv.org/abs/2609.13507)
...
### [36] [A Three-Axis Stress Test of LLM vs Classical ML for Network Intrusion Detection under Distribution Shift and Adversarial Evasion](https://arxiv.org/abs/2609.13511)
...
### [37] [Adaptive Phase-Switching for Communication-Efficient Federated LoRA Fine-Tuning](https://arxiv.org/abs/2609.13512)
...
### [38] [Operational Range Bounding in Spectroscopy: A Safety Cage Framework for Machine Learning Models](https://arxiv.org/abs/2609.13514)
...
### [39] [GeoTTER: Leveraging Local Geometry of Optimal Transport for Zero-Shot Classification](https://arxiv.org/abs/2609.13518)
...
### [40] [Rolling Day-Wise Mortality Prediction in Critically Ill Patients With AKI on CRRT Utilizing Machine Pressure Waveforms](https://arxiv.org/abs/2609.13524)
...
### [41] [Generative Interpretability via Scalable Neuro-Symbolic Models](https://arxiv.org/abs/2609.13529)
*Xiaocong Yang*
...
### [42] [Attention Is All You Need (to Avoid Spurious Oscillations)](https://arxiv.org/abs/2609.13531)
...
### [43] [Toward Optimal Switching Regret for Multi-Armed Bandits with Oblivious Adversary](https://arxiv.org/abs/2609.13547)
*Mengxiao Zhang*
...
### [44] [When Greedy Sampling Explores: KL-Regularized Contextual Bandits without Eluder-Dimension Dependence](https://arxiv.org/abs/2609.13564)
...
### [45] [AttnFuse: A Composable DSL for Compiling Attentions to Fused GPU Kernels](https://arxiv.org/abs/2609.13612)
...
### [46] [An Efficient and Modular Framework for Targeted Harm Mitigation in LLMS](https://arxiv.org/abs/2609.13624)
...
### [47] [FlowTSFM: Turning Encoder Depth into Quantile Transport](https://arxiv.org/abs/2609.13640)
...
### [48] [When Compliance Data Masquerades as Evaluation: Measurement Validity for Deployed AI Systems](https://arxiv.org/abs/2609.13642)
...
### [49] [Curvature-Independent Regret Bounds for Distributed Online Optimization on Hadamard Manifolds](https://arxiv.org/abs/2609.13646)
...
### [50] [Online Bayesian Node Classification on Inductive Graphs under Distribution Shift](https://arxiv.org/abs/2609.13655)
...
### [51] [Leakage-Safe and Scheduler-Aware Machine Learning for Grid Job Runtime Prediction](https://arxiv.org/abs/2609.13701)
...
### [52] [Certifying Model Upgrades with Slice-Wise Non-Regression and Incumbent Fallback](https://arxiv.org/abs/2609.13714)
...
### [53] [A Variational Optimal Transport Operator on Incompressible Flow](https://arxiv.org/abs/2609.13729)
...
### [54] [JumpStart Your Policy Learning with Lessons from 160,000 Training Runs](https://arxiv.org/abs/2609.13730)
...
### [55] [HarnessBandit: Joint Learnability-Transferability Scheduling for Multi-Harness Agentic Reinforcement Learning](https://arxiv.org/abs/2609.13739)
...
### [56] [Training Specialist Models without Reasoning Trajectories for Domain Expert Distillation](https://arxiv.org/abs/2609.13770)
...
### [57] [Does Reasoning Improve Psychological Depth in Large Language Models? It Depends on Who's Judging](https://arxiv.org/abs/2609.13773)
...
### [58] [PPDL: A Real-world Industrial User Retention Ratio Forecasting Framework Integrating Physical Priors with Deep Learning](https://arxiv.org/abs/2609.13789)
...
### [59] [Benchmarking Optimizers to Solve Inverse Problems with Differentiable Physics Simulators](https://arxiv.org/abs/2609.13819)
...
### [60] [Graph Neural Networks for Influence Maximization in Social Networks: An Unsupervised Minimum Dominating Set Approach](https://arxiv.org/abs/2609.13836)
...
### [61] [Accuracy Is Not Service: A Decision-Aware Benchmark for Intermittent-Demand Forecasting](https://arxiv.org/abs/2609.13840)
...
### [62] [Pre-training with Graph Transformers](https://arxiv.org/abs/2609.13844)
...
### [63] [Affinity-Aware Sharding for Delayed Tensor Parallelism](https://arxiv.org/abs/2609.13846)
*Eloi de Reynal*
...
### [64] [ReH-FUSE: Reliability-Aware Hierarchical Fusion of Experts for Multimodal Emotion Recognition in Conversation](https://arxiv.org/abs/2609.13857)
...
### [65] [An Uncertainty-Aware Hybrid Mathematical-Machine-Learning Model for Smart Irrigation Decision Support](https://arxiv.org/abs/2609.13864)
*Andrea Scariolo*
...
### [66] [The Filter Metric is Safety-Critical: Phantom Advantages in Group-Relative RL under Shaped Rewards](https://arxiv.org/abs/2609.13866)
*Juntao Yu*
...
### [67] [A Multi-Resolution Multi-Domain Pre-Training Framework for Universal Traffic Forecasting](https://arxiv.org/abs/2609.13878)
...
### [68] [Lie to me: Detecting Managerial Evasiveness in Earnings Calls via Conversational Audio Encoders](https://arxiv.org/abs/2609.13893)
...
### [69] [Machine Learning under Imperfect Data: Challenges and Methods](https://arxiv.org/abs/2609.13914)
*Masoumeh Zareapoor*
...
### [70] [Learning Through Energy Refinement and Manifold Projection: A Cooperative EBM-AE Framework](https://arxiv.org/abs/2609.13917)
*Ryad Zemouri*
...
### [71] [Machine Learning in Fish Farming](https://arxiv.org/abs/2609.13919)
...
### [72] [Finite-Time Node Separation in Recurrent Graph Neural Networks with Persistent Gaussian Perturbations](https://arxiv.org/abs/2609.13920)
...
### [73] [Minibatch persistency, eight years later: what batch reuse costs in steps and joules, and what it saves in data](https://arxiv.org/abs/2609.13922)
*Matteo Fischetti*
...
### [74] [Exploring napping paradigm for Recurrent Spiking Neural Networks](https://arxiv.org/abs/2609.13927)
...
### [75] [Optimal Transport for Efficient, Unsupervised Anomaly Detection on Industrial Data](https://arxiv.org/abs/2609.13940)
...
### [76] [Hardware-Aware Learned Representation Compression for Distributed In-Sensor Vision](https://arxiv.org/abs/2609.13947)
...
### [77] [Linear Ensemble Sampling with Smaller Ensembles](https://arxiv.org/abs/2609.13954)
...
### [78] [Tabby: An Open Pretraining Recipe for Time Series Foundation Models](https://arxiv.org/abs/2609.13956)
...
### [79] [Data-Efficient Agentic Graph Domain Adaptation via Reliability-Aware Prototype Learning](https://arxiv.org/abs/2609.14045)
...
### [80] [Stabilizing Performative Feedback Loops with Minimal Model Deployments](https://arxiv.org/abs/2609.14065)
...
### [81] [Multi-Modal Tumor Survival Prediction via Graph-Guided Mixture of Experts](https://arxiv.org/abs/2609.14072)
*H Mathavan,H Liu*
...
### [82] [LIMBO: Lifelong Inference-Time Memory and Budget Optimization for LLM Agents](https://arxiv.org/abs/2609.14138)
...
### [83] [T-SMART: Mechanism-Level Attribution for Tool-Augmented Time-Series Question Answering](https://arxiv.org/abs/2609.14142)
...
### [84] [Signatures of Steerability in Activation Space of Language Models](https://arxiv.org/abs/2609.14151)
...
### [85] [CyFM: Cylindrical Optimal Transport for Few-Step Complex-Valued Flow Matching](https://arxiv.org/abs/2609.14171)
...
### [86] [Inherited Heads: Audio language models track speakers with their text backbone's attention, and an attention-mass ranking retrieves a different set](https://arxiv.org/abs/2609.14174)
*Bojro Das*
...
### [87] [A Machine Learning Framework for Fault Detection, Isolation, and Severity Prediction of Autonomous VTOL Aircraft](https://arxiv.org/abs/2609.14180)
...
### [88] [ZAPS: Zero-Cost Active Proxy Search for Neural Architecture Search](https://arxiv.org/abs/2609.14184)
...
### [89] [Entropy-Punctured Bloom Filters for Memory-Efficient Machine Learning](https://arxiv.org/abs/2609.14187)
...
### [90] [Data-free On-policy Distillation](https://arxiv.org/abs/2609.14193)
...
### [91] [Graph-Transformer Fraud Detection with Self-Supervised Pretraining and Conformal Risk Control](https://arxiv.org/abs/2609.14234)
*Sergei,Komarov*
...
### [92] [CoArena: Evaluating Computer-Use and Multi-Agent Systems in Real Time](https://arxiv.org/abs/2609.14239)
...
### [93] [Bayesian optimization with kernel ensembles and disagreement-based acquisition for source localization and acoustic inversion](https://arxiv.org/abs/2609.14262)
...
### [94] [Learning Source Acquisition Policies by Offline Planning](https://arxiv.org/abs/2609.14299)
...
### [95] [Nonparametric Variance-Penalized Actor-Critic: Statistical Inference for Risk-Sensitive Reinforcement Learning](https://arxiv.org/abs/2609.14327)
...
### [96] [Communication-Efficient LLM Adaptation over Decentralized GPU Meshes](https://arxiv.org/abs/2609.14339)
...
### [97] [Multimodal deep learning from spectra for small-molecule structure identification: enhancing robustness with mixed-condition training](https://arxiv.org/abs/2609.14360)
...
### [98] [Towards Identifying the Dataset Biases Causing Phantom Transfer](https://arxiv.org/abs/2609.14449)
...
### [99] [Follow the Geometry, Not the Model: Cold Start Semi-Supervised Learning](https://arxiv.org/abs/2609.14451)
...
### [100] [Retrieval-Guided Fine-Tuning as Noisy Estimation: Risk bounds and Architectural Analysis](https://arxiv.org/abs/2609.14485)
...
### [101] [Should All Noises Be Treated Equally: Impact of Input Noise Variability on Neural Network Robustness](https://arxiv.org/abs/2609.14504)
...
### [102] [GNN4PPM: Multi-Target Predictive Process Monitoring with Relational Graph Convolutional Networks](https://arxiv.org/abs/2609.14534)
...
### [103] [Selecting k Paths with the Minimum Longest Path Length in the Stochastic Semi-Bandit Setting](https://arxiv.org/abs/2609.14557)
...
### [104] [Pathwise Individual Rationality in Federated Learning: A Mechanism-Architecture Co-Design](https://arxiv.org/abs/2609.14591)
...
### [105] [Diagnosing Temporal Misalignment in Multichannel Time-Series Classification with Minimum Description Length](https://arxiv.org/abs/2609.14595)
...
### [106] [SH-WRNN: Implicit Spherical Harmonics Weight Field Routing Neural Networks for Asymmetric Edge Intelligence](https://arxiv.org/abs/2609.14614)
...
### [107] [Know When to Stop, Where to Restart: Accelerating Multi-Turn Agentic On-Policy Distillation](https://arxiv.org/abs/2609.14636)
...
### [108] [Symmetries and Singularities](https://arxiv.org/abs/2609.14663)
...
### [109] [WaterKron and FlipFlop Hessian: Information-Theoretically Grounded Quantization with Kronecker-factored Hessians](https://arxiv.org/abs/2609.14706)
...
### [110] [An immune world model for multiscale forecasting and therapeutic hypothesis generation](https://arxiv.org/abs/2609.14709)
...
### [111] [GRPO-QM: Target Preserving Exploration for Quantum Tomography](https://arxiv.org/abs/2609.14711)
...
### [112] [Carryover Drafting: Recycling Rejected States for Speculative Decoding](https://arxiv.org/abs/2609.14717)
...
### [113] [Are Gradient Boosting Models Suitable for Intermittent Demand Forecasting?](https://arxiv.org/abs/2609.14718)
...
### [114] [WaVeFuse: Regime-Adaptive Equity Index Forecasting via Channel-Wise Wavelet Denoising and Vertical Attention Fusion](https://arxiv.org/abs/2609.14733)
...
### [115] [OCT-FedSIR: Toward Trustworthy Federated Ophthalmic Learning under Annotation Noise](https://arxiv.org/abs/2609.14734)
...
### [116] [Calibrating Interpretability Instruments Before Trusting Their Verdicts](https://arxiv.org/abs/2609.14754)
...
### [117] [Refusal Reads Only a Slice of What the Model Knows: Harm-Keyed Routing and Its Exceptions Across Model Families](https://arxiv.org/abs/2609.14759)
*Orion Reblitz-Richardson*
...
### [118] [Privacy Preserving Gossip Learning](https://arxiv.org/abs/2609.14778)
...
### [119] [Decision-Oriented Uncertainty Quantification for Risk Control in Earth System Spatiotemporal Foundation Models](https://arxiv.org/abs/2609.14821)
...
### [120] [Tackling Failure Modes of PINNs and PIKANs Using Conflict-Free Gradients](https://arxiv.org/abs/2609.14841)
...
### [121] [Semantic Fibers and Cross-Gram Interference: A Calculus of Safety Drift in Overcomplete Representations](https://arxiv.org/abs/2609.14861)
...
### [122] [Interpolation Is Not Invariance: Pair Count Is Not Coverage in Transformation Audits](https://arxiv.org/abs/2609.14870)
...
### [123] [AgentKV: Phase-Aware KV Eviction for Agentic LLMs](https://arxiv.org/abs/2609.14872)
...
### [124] [SeqMaestro: From nucleotide sequences to biological hypotheses through interpretable machine learning](https://arxiv.org/abs/2609.14882)
...
### [125] [Cross-Block Conditioning in Deep Boltzmann Machines for Statistical Data Fusion](https://arxiv.org/abs/2609.14934)
*Junichiro Niimi*
...
### [126] [Cloud Workflow Scheduling Based on Graph Attention-Driven Hierarchical Reinforcement Learning](https://arxiv.org/abs/2609.14952)
...
### [127] [High-Probability Nash Regret for Decentralized Learning in Markov $α$-Potential Games: Episodic and Fully Online Asynchronous Algorithms with Applications to Markov Congestion Games](https://arxiv.org/abs/2609.14959)
*S. Rasoul Etesami*
...
### [128] [HiGFRL: Hierarchical Graph Fusion-Driven Reinforcement Learning for Dependency-Aware Task Scheduling in Heterogeneous Cloud](https://arxiv.org/abs/2609.14968)
...
### [129] [Learning to Solve Stochastic Controls with Unknown Drifts and Running Rewards: Theory, Algorithms and Convergence](https://arxiv.org/abs/2609.14972)
...
### [130] [LiftGCN: Efficient Energy-Preserving Graph Learning via Joukowski Spectral Lifting for Finite Element Stress Prediction](https://arxiv.org/abs/2609.14977)
*Chen Zeng,Qiao Wang*
...
### [131] [HGTO: A Unified Graph-Based Physics-Informed Formulation for Structural Topology Optimization](https://arxiv.org/abs/2609.15001)
...
### [132] [Pick Your Poison: Learning to Select Poison Sets for Stronger LLM Backdoor Attacks](https://arxiv.org/abs/2609.15029)
...
### [133] [Not All Prompts Are Equal: Exploration-Guided Prompt Scaffolding for Multimodal Reinforcement Post-Training](https://arxiv.org/abs/2609.15051)
...
### [134] [What Does an LLM Learn from Reinforcement Learning? A Mechanistic Interpretability Perspective with Fixed-SAE Track](https://arxiv.org/abs/2609.15064)
...
### [135] [Sensory Precision Inference for Multimodal Arbitration under Uncertainty](https://arxiv.org/abs/2609.15065)
...
### [136] [Branched Optimal Transport Amortization](https://arxiv.org/abs/2609.15072)
...
### [137] [Ensemble-Conditioned Molecular Design](https://arxiv.org/abs/2609.15077)
...
### [138] [$\mathbb{SL}(n)$ Representation Learning: An Intrinsic Mixed-Curvature Space with Higher Curvature Capacities and Deeper Order-Aware Composition](https://arxiv.org/abs/2609.15083)
...
### [139] [Beyond Numerical Time Series: A Unified Benchmark for Multimodal Forecasting with Heterogeneous Context](https://arxiv.org/abs/2609.15087)
...
### [140] [Omni-Streaming Thinking](https://arxiv.org/abs/2609.15128)
...
### [141] [Multi-source Transfer Learning of Time Series with a Shapelet-based Distance Measure](https://arxiv.org/abs/2609.15148)
...
### [142] [Nearly Minimax-Optimal Regret for Linear Contextual Bandits with Arbitrary Adaptive Action Sets](https://arxiv.org/abs/2609.15170)
*Tianyuan Jin*
...
### [143] [Temporal Self-Distillation: Faster Inference in Discrete Diffusion Language Models](https://arxiv.org/abs/2609.15177)
...
### [144] [Rethinking Correctness for Uncertainty Estimation in Clinical Prediction with Vision-Language Models](https://arxiv.org/abs/2609.15180)
...
### [145] [Convergence rates for generative drifting flows: fixed-scale obstructions and multihead acceleration](https://arxiv.org/abs/2609.15193)
...
### [146] [ProtoGuide: Prototype-Driven Guidance for Class-Conditional Graph Generation](https://arxiv.org/abs/2609.15239)
...
### [147] [Bandits with Probing: Optimal Regret and the Limits of Winner Feedback](https://arxiv.org/abs/2609.15248)
*Yongjie Guan*
...
### [148] [BioDCASE: Active Learning for Bioacoustics](https://arxiv.org/abs/2609.15255)
...
### [149] [Draining Fictitious Knots: Restoring Distance-Awareness Guarantees for High-Dimensional Spline Networks](https://arxiv.org/abs/2609.15274)
...
### [150] [Impute-EM: Native Mixed-State Diffusion Models for Heterogeneous Data Imputation](https://arxiv.org/abs/2609.15284)
...
### [151] [Admissable: Training Reinforcement Learning Agents against Adversarial Missingness](https://arxiv.org/abs/2609.15297)
...
### [152] [When Correlations Mislead: Confounder-Aware Multi-View Urban Region Representation Learning](https://arxiv.org/abs/2609.15305)
...
### [153] [The Universe of Universes: Benefit Yield Functions, Implosion Thresholds, and Infrastructure-Aware Optimization in Multi-LLM Systems](https://arxiv.org/abs/2609.15314)
...
### [154] [Robust and Efficient Communication for Multi-Agent Learning](https://arxiv.org/abs/2609.15361)
...
### [155] [Representing Clinical Conditions on Vital Signs from Healthy Individuals using Latent Modeling](https://arxiv.org/abs/2609.15379)
...
### [156] [CodeTS: Verifiable Text-to-Time Series Generation via Executable Code](https://arxiv.org/abs/2609.15393)
...
### [157] [Single-condition neural solvers encode transferable response spaces for parametric differential equations](https://arxiv.org/abs/2609.15432)
...
### [158] [On the role of the tokenizer in ECG transformer models](https://arxiv.org/abs/2609.15433)
...
### [159] [Same path, different: a mechanistic comparison of looped and stacked transformer encoders on 12-lead ECG](https://arxiv.org/abs/2609.15498)
...
### [160] [End-to-End Verifiable and Robust Federated Learning](https://arxiv.org/abs/2609.15521)
...
### [161] [The Misery of Mechanistic Interpretability: A Formal Perspective](https://arxiv.org/abs/2609.15533)
...
### [162] [Specifying Reward Functions for RL Without Environment Sampling](https://arxiv.org/abs/2609.15544)
...
### [163] [Backward SDEs-based Diffusion for Physics-Constrained Generation](https://arxiv.org/abs/2609.15702)
*Zihao Wang*
...
### [164] [Assembling the CREW: A Collaborative Multi-agent Reinforcement Learning Framework for Automated Related Work Generation](https://arxiv.org/abs/2609.15721)
...
### [165] [A Language-Guided Multimodal Foundation Model for Zero-Shot and Multi-Task Brain Signal Analysis](https://arxiv.org/abs/2609.15740)
...
### [166] [Sylvas: Synergistic Learning Value based Device Scheduling in Federated Continual Learning](https://arxiv.org/abs/2609.15763)
...
### [167] [Transfer Learning for Socioeconomic Estimation in Forced-Displacement Settings](https://arxiv.org/abs/2609.15773)
...
### [168] [Sharp Rates and a One-Line Correction for Spectral Representation Learning](https://arxiv.org/abs/2609.15825)
...
### [169] [LLM-Based Schema-Aware Split Learning for Privacy-Preserving Mental Distress Prediction Across Heterogeneous Surveys](https://arxiv.org/abs/2609.15871)
...
### [170] [Privacy-enhanced federated learning via asynchronous aggregation and local differential perturbation](https://arxiv.org/abs/2609.15885)
...
### [171] [CUDA-Q Logical: Retargetable Compilation for Fault-Tolerant Quantum Computing](https://arxiv.org/abs/2609.13388)
...
### [172] [High quantum local differential privacy breaks entanglement](https://arxiv.org/abs/2609.13418)
...
### [173] [Reusable selected-time channels for quantum simulation of non-Markovian dynamics](https://arxiv.org/abs/2609.13456)
*Yusui Chen*
...
### [174] [Reservoir Support Sets the Minimum Loss for Non-Hermitian Dynamics](https://arxiv.org/abs/2609.13496)
*Alena Mastiukova*
...
### [175] [Practical Considerations for Processing Massive Classical Data via Quantum Oracle Sketching](https://arxiv.org/abs/2609.13549)
*Stefano Markidis*
...
### [176] [An entropic characterization of Haag duality](https://arxiv.org/abs/2609.13550)
...
### [177] [Batched pattern search for QAOA parameter optimization on cloud-accessed quantum hardware](https://arxiv.org/abs/2609.13669)
*Muhammad Faryad*
...
### [178] [Open Quantum Systems](https://arxiv.org/abs/2609.13863)
...
### [179] [Hiai--Petz Skew Informations and Sharp Uncertainty Relations for a Single Observable](https://arxiv.org/abs/2609.13870)
*Gen Kimura*
...
### [180] [Noise-aware derivative feedback of a harmonic oscillator under quantum-limited position measurement](https://arxiv.org/abs/2609.13988)
*Vedran Vujnović*
...
### [181] [Formulating Multistage Cutting Stock Problems as QUBO](https://arxiv.org/abs/2609.14070)
...
### [182] [Torsion detection in clique complexes is conditionally $QMA_1$-hard](https://arxiv.org/abs/2609.14110)
*Adam Wesołowski*
...
### [183] [Fast CZ gate in hybrid fluxonium-transmon systems with tunable couplers](https://arxiv.org/abs/2609.14197)
...
### [184] [Trace-Norm Overlaps of Quantum States: Interpolation, Equality, and Data-Processing Rigidity](https://arxiv.org/abs/2609.14203)
...
### [185] [An All-van-der-Waals Qubit](https://arxiv.org/abs/2609.14230)
...
### [186] [Efficient expectation value estimation for quantum circuits via extended stabilizer frameworks and adaptive variance estimation](https://arxiv.org/abs/2609.14252)
...
### [187] [Engineering non-Markovianity from spectral shaping of bosonic and fermionic baths](https://arxiv.org/abs/2609.14341)
...
### [188] [Quantum synchronization: A tutorial guide](https://arxiv.org/abs/2609.14375)
...
### [189] [Certification cost of quantum models: measurement correlation, not parameter count](https://arxiv.org/abs/2609.14424)
...
### [190] [Indistinguishability Theory for Identical Particles with Invariant Degrees of Freedom](https://arxiv.org/abs/2609.14428)
*Valery Shchesnovich*
...
### [191] [From breakfast, lunch, and dinner to the Bell-inequality tetrahedron](https://arxiv.org/abs/2609.14436)
*Francesco Giacosa*
...
### [192] [Squeezing measurement with spectrally broadened in microstructured fiber local oscillator](https://arxiv.org/abs/2609.14454)
...
### [193] [Arithmetic of Bohr Frequencies Governs Uniform Mixing in Randomly Timed Quantum Spin Chains](https://arxiv.org/abs/2609.14463)
*Musung Kang*
...
### [194] [NAQsim: Full-Stack Architecture Simulation Framework for Fast and Space-Efficient Neutral Atom Quantum Computing](https://arxiv.org/abs/2609.14478)
...
### [195] [Exact computation of quantum wave functions for nonlinear potentials](https://arxiv.org/abs/2609.14480)
...
### [196] [Preparation of Multimode NOON States via Floquet-Engineered Conditional Chiral Excitation](https://arxiv.org/abs/2609.14524)
...
### [197] [Parameter-Efficient Quantum NLP for Paraphrase Detection: Performance, Robustness, and Entanglement](https://arxiv.org/abs/2609.14529)
...
### [198] [Proving olympiad geometry theorems on a superconducting quantum processor](https://arxiv.org/abs/2609.14533)
...
### [199] [Controlling quantum state transfer in rooted products](https://arxiv.org/abs/2609.14537)
...
### [200] [Exact $1/4$ mean-rung population and $\sqrt{2}$ continuum revival-time ratio in the anti-Jaynes--Cummings vertex at $f_\star=\sqrt{\bar n+1}$](https://arxiv.org/abs/2609.14563)
...
### [201] [Simulating Quantum Physics Experiments One Event at a Time](https://arxiv.org/abs/2609.14600)
*Hans De Raedt*
...
### [202] [A pretty-tight converse on the classical capacity of generalized amplitude-damping channels](https://arxiv.org/abs/2609.14621)
*Kun Fang*
...
### [203] [Linear equations mod $n$ are pseudo-telepathic](https://arxiv.org/abs/2609.14632)
*Lorenzo Ciardo*
...
### [204] [Collective-dissipation-controlled thermal rectification and entropy production in a three-terminal three-qubit XXZ spin chain](https://arxiv.org/abs/2609.14644)
...
### [205] [Systematic construction of multiqubit unextendible product bases](https://arxiv.org/abs/2609.14788)
...
### [206] [Universal Defect Statistics in Reverse Quenches](https://arxiv.org/abs/2609.14960)
...
### [207] [Failure of the Asymptotic Equipartition Property for Quantum Channels](https://arxiv.org/abs/2609.15004)
*Gilad Gour*
...
### [208] [Fermionic quantum error correction is never free](https://arxiv.org/abs/2609.15059)
...
### [209] [Biorthogonal Time-Dependent Variational Principle for Non-Hermitian Systems](https://arxiv.org/abs/2609.15099)
...
### [210] [A train--prune--readout--rewrite workflow for interpretable quantum learning](https://arxiv.org/abs/2609.15139)
...
### [211] [Comment on J.Qin et al., Unconditional and Robust Quantum Metrological Advantage beyond N00N States, PRL 130, 070801 (2023) and J.A. H. Nielsen et.al., Deterministic Quantum Phase Estimation beyond N00N States. PRL 130, 123603 (2023)](https://arxiv.org/abs/2609.15212)
...
### [212] [Feature-Adaptive Fusion in Hybrid Quantum-Classical Neural Networks for Robust Biomedical Image Classification](https://arxiv.org/abs/2609.15267)
...
### [213] [Variational Real-Time Dynamics on Reduced Operator Manifolds](https://arxiv.org/abs/2609.15272)
...
### [214] [Klein Tunneling of Dirac Fermions through Electromagnetic Barriers](https://arxiv.org/abs/2609.15287)
...
### [215] [Universality from Quadratic Angular-Momentum Operations: Exact Dynamical Lie Algebras and the Role of the Casimir Obstruction](https://arxiv.org/abs/2609.15302)
...
### [216] [Improving precision scaling via backaction-evading continuous measurement in a driven-dissipative Kerr parametric oscillator](https://arxiv.org/abs/2609.15345)
...
### [217] [Electromagnetic Selection Rules and Coherent Manipulation of Quantum Skyrmion via Surface Acoustic Wave Phonons](https://arxiv.org/abs/2609.15456)
...
### [218] [Engineering dissipation and control pulses for high-fidelity fault-tolerance quantum computing](https://arxiv.org/abs/2609.15477)
...
### [219] [Bell-inequality violation in light transmitted through disordered emitter ensembles](https://arxiv.org/abs/2609.15575)
...
### [220] [Information Erasure and Quantum Imprint in Quantum Measurement and First-Order SPAM Error Separation](https://arxiv.org/abs/2609.15586)
...
### [221] [Parametric two-qubit gates via Landau-Zener interference](https://arxiv.org/abs/2609.15604)
...
### [222] [Reducing Decoding Latency in Quantum Error Correction by Early Starting Clustering](https://arxiv.org/abs/2609.15612)
...
### [223] [Distribution of light-matter quantum correlations with a temporally multiplexed solid-state quantum memory array](https://arxiv.org/abs/2609.15689)
...
### [224] [Performance in Symmetry-Restricted Searches for Post-Quantum Correlations](https://arxiv.org/abs/2609.15705)
...
### [225] [A Modular, Topology-Aware Software Stack for Entanglement-Based Distributed Quantum Computing](https://arxiv.org/abs/2609.15728)
...
### [226] [Disentangling QAOA: From Weakly Entangled Circuits to a Classical QUBO Solver](https://arxiv.org/abs/2609.15738)
...
### [227] [Pauli spectrum and nonstabilizerness of random fermionic Gaussian states](https://arxiv.org/abs/2609.15739)
...
### [228] [Optimal entanglement-assisted source coding under a balanced-difference promise](https://arxiv.org/abs/2609.15757)
*Julius A. Zeiss*
...
### [229] [Low-Depth Initial-State Preparation for Ground-State Energy Estimation of Two-Dimensional Strongly Correlated Systems](https://arxiv.org/abs/2609.15764)
...
### [230] [Security framework for practical quantum key distribution with imperfect devices](https://arxiv.org/abs/2609.15790)
...
### [231] [Higher-order quantum thermodynamics: equilibrium and causal structure](https://arxiv.org/abs/2609.15829)
...
### [232] [Limits on the atomic description of four-wave mixing](https://arxiv.org/abs/2609.15843)
...
### [233] [Generation of entanglement and magic via continuous homodyne monitoring of a qubit pair](https://arxiv.org/abs/2609.15868)
...
### [234] [Strong-coupling quantum optics in free space with holes in a Fermi sea](https://arxiv.org/abs/2609.15935)
...
### [235] [Digital Twin of an Argon-Hydrogen Plasma Reactor](https://arxiv.org/abs/2609.15250)
...
### [236] [A Symmetry-Constrained Fourier--Morse Framework for Compact Anisotropic Interaction Potentials](https://arxiv.org/abs/2609.15405)
...
### [237] [Neural Modal Decomposition: Architectural Priors from Observables](https://arxiv.org/abs/2609.14402)
